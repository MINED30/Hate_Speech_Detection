...
![<그림 1> 수집한 데이터셋 간의 검증 결과](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8f7405f8-d5ea-4a89-9204-c8172367d52c/Untitled.png)

<그림 1> 수집한 데이터셋 간의 검증 결과
...
![<표 2> 데이터 조합 검증 결과](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/77f3bd74-0e47-47a7-82f6-61f3c667ffa7/Untitled.png)
...
![<그림 2> 각 모형의 마지막 레이어의 결과를 PCA를 통해 시각화 한 것](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d4afae90-8aab-4440-8cc1-c331090abbd2/Untitled.png)

<그림 2> 각 모형의 마지막 레이어의 결과를 PCA를 통해 시각화 한 것
...
![<Figure 3> Elapsed time to inference 2 or 5 sentences](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/373c0544-8adf-4099-82bc-1bf0b64506da/Untitled.png)

<Figure 3> Elapsed time to inference 2 or 5 sentences

The benchmark was conducted in Colab without a hardware accelerator, and Intel(R) Xeon(R) CPU @ 2.00 GHz was assigned. The sentence used to measure the time is "Hello, My Name is Changwoo. Hello, Mind Logic. Hello, CodeStates". In order to include the context, two or five sentences were repeated a total of 5000 times, and 10% of each was removed in order to erase the abnormal measurement. Finally, 4000 pieces of measured data were evaluated. Mean and error are as in <Table>. It is summarized in <Table 4> based on the 95% confidence interval (mean ± 2 standard deviations).

![<Table 4> Elapsed time to inference 2 or 5 sentences](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d484d16a-997d-461e-ace8-c9c26458189c/Untitled.png)

<Table 4> Elapsed time to inference 2 or 5 sentences
...
![<Figure 4> BentoML operation screen: When class prediction is different through context](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/704fef08-67d0-48b0-85e1-19e394130ea7/Untitled.png)

<Figure 4> BentoML operation screen: When class prediction is different through context
